<?php
    ...
    if(isset($_GET['add'])){
        ...
        for($i=0;$i<$count_images;$i++)
        {
            ...
            $image_folder="images/agent/property_images/";
        ...
        mysqli_query($con,"INSERT INTO `properties`(`prop_title`,`prop_desc`,`prop_image`,`prop_address`,`prop_price`,`prop_type`,`prop_date`,`user_id`,`approval`,`user_type`,`prop_area`,`prop_bhk`,`prop_sqrft`)
        VALUES('$prop_title','$prop_desc','$image_name_imploded','$prop_address','$prop_price','$prop_type','$upload_date','$loginId','requested','agent','$prop_area','$prop_bhk','$prop_sqrft')") or die(mysqli_error($con));

        header('location:manage_prop.php?success&&name=properties');
    }
        ...
        mysqli_query($con,"UPDATE `properties` SET `prop_title`='$prop_title',`prop_desc`='$prop_description',
        ...
        $property_id=$_GET['prop_id'];
        mysqli_query($con,"UPDATE `properties` SET `approval`='approved' WHERE `prop_id`='$property_id'");
        header('location:view_prop.php?approved');
    }
        ...
        if($query){
            header('location:view_prop.php?success&&name=property');
        }
    }
        ...
        if($query){
            header('location:agentPropGallary.php?prop_id='.$property_id);
        }
    }
